  ...
  return (
    <div className={"prose prose-lg prose-indigo m-auto mt-12 text-left max-w-[60vw]"}>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Fulcrum, the software program provided by the Company.
          </p>
        </li>
        <li>
          <p>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to Fulcrum.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        <a href={"/home/contact"} target="_blank" className={"mb-8"}>
          Contact Us
        </a>
      </p>
    </div>
