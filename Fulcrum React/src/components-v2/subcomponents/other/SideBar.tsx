  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`flex flex-col justify-start items-center relative h-screen bg-[#1e3836] dark:bg-[#223136] text-primary overflow-hidden pl-3 pr-4 transition-all duration-600 ease-out"}`}
      >
        {sideBarOpen ? (
