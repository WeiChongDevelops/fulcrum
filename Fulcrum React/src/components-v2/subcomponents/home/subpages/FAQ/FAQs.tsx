...
export default function FAQs() {
  return (
    <div className={"w-screen h-screen py-16 bg-gradient-to-b from-emerald-100 to-white"}>
      <div className={"prose mx-auto max-w-[80vw] relative"}>
        <img
          src="/assets-v2/homepage-assets/homepage-highlight-5.png"
        ...
        <div className={"flex flex-row justify-center items-center mt-8 gap-4"}>
          <img src="/assets-v2/homepage-assets/homepage-highlight-3.png" className={"w-4"} alt="" />
