...
export default function Wall({ user }: WallProps) {
  ...
  return (
    ...
    >
      ...
      <img src="/assets-v2/other-assets/web-tl.png" alt="?" className={"absolute -left-10 -top-10 w-[30vw] h-[30vw]"} />
      <img src="/assets-v2/other-assets/web-tr.png" alt="?" className={"absolute right-0 -top-2"} />
      <img
        src="/assets-v2/other-assets/web-bl.png"
        alt="?"
        className={"absolute -left-24 bottom-12 -rotate-90 max-w-[26vw]"}
      />
      <img src="/assets-v2/other-assets/web-br.png" alt="?" className={"absolute -right-8 -bottom-12 rotate-180"} />
      <p
        className={
