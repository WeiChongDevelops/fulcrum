...
export default function Group({ groupName,
    ...
    return (
        <div className="group flex flex-col rounded-xl p-2 mb-5" style={{backgroundColor: groupColour, filter: publicUserData.darkModeEnabled ? "brightness(80%)" : "brightness(100%)"}}>
