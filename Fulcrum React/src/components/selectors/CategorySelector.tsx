import {
    colourStyles, ExpenseCreationFormData, ExpenseUpdatingFormData,
    PreviousExpenseBeingEdited, PreviousRecurringExpenseBeingEdited,
    RecurringExpenseInstanceUpdatingFormData, RecurringExpenseUpdatingFormData,
...
interface CategorySelectorProps {
    ...
    setFormData: (Dispatch<SetStateAction<RecurringExpenseInstanceUpdatingFormData>>
...
export default function CategorySelector( { categoryOptions, oldExpenseBeingEdited, setFormData }: CategorySelectorProps) {
    ...
    function handleCategoryInputChange(e: any) {
        setFormData((currentFormData: any) => ({ ...currentFormData, category: e.value }));
    }
    ...
    return (
        <CreatableSelect
            id="category"
            name="category"
            defaultValue={ oldExpenseBeingEdited && {
