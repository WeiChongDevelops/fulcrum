 ...
 */
export default function RecurringExpenses({ setOpenToolsSection, publicUserData, budgetArray, groupArray, setExpenseArray, setBudgetArray, categoryDataMap, error, setError }: RecurringExpensesProps) {
    ...
    return (
        <div>
            {!isLoading ? <div className="justify-start items-center bg-[#455259] min-h-screen">
                ...
                </div> : <p className={`error-message "text-white"`}>{error}</p>}
