        ...
        <div className={"flex flex-col justify-start items-center w-screen px-20 pt-40 pb-6 text-black relative"}>
            <div className={"upper-copy-first-row"}>
                <div className={"upper-copy-left-col mr-8 sm:mr-32"}>
                    <img src="/src/assets/homepage-assets/homepage-highlight-1.png" className={"w-8 absolute left-[100%] top-0"} alt="Page highlight"/>
                    ...
                    <div className={"flex flex-row justify-start items-center mb-8"}>
                        ...
                        <div className={"flex flex-row justify-start items-center rounded-full bg-[#F7FFFAFF] py-2 pl-2.5 pr-6 ml-2"}>
                            <img src="/src/assets/homepage-assets/kylie.png"
                                 className={"rounded-full border-4 border-white w-20 hover:scale-110 transition-transform ease-out duration-150"}
                ...
                <div className={"upper-instructions-container"}>
                    ...
                    <div>
                        ...
                        <img src="/src/assets/homepage-assets/homepage-highlight-2.png" className={"w-8 absolute left-[90%] bottom-0"} alt="Page highlight"/>
                    </div>
                </div>
            </div>
            <div className={"relative overflow-hidden flex flex-col justify-center items-center rounded-lg w-[90vw] h-60 bg-[#282d33] text-white text-xl shadow-[1rem_1rem_0_black] select-none mt-40"} ref={spotlightContainerRef}>
                ...
                <img src="/src/assets/homepage-assets/complicated.png" className={"w-[30rem] sm:w-[42rem] mb-3 relative z-10"} alt="Homepage copy"/>
            ...
            <div className={"flex flex-row justify-start items-center relative mt-20 font-bold text-lg sm:text-[1.7rem]"}>
                <img src="/src/assets/homepage-assets/homepage-highlight-3.png" className={"w-2 sm:w-5 mr-6 mb-3"} alt="Page highlight"/>
                <div className={"flex flex-row justify-center"}>
                    <p>All the features you need, for free,</p>
                    <div className={"flex flex-col items-center sm:ml-1"}>
                        <p>forever.</p>
                        <img src="/src/assets/homepage-assets/homepage-highlight-4.png" className={"w-20 sm:w-[6.5rem] -bottom-[1rem]"} alt="Page highlight"/>
                    </div>
                </div>
            </div>
        </div>
