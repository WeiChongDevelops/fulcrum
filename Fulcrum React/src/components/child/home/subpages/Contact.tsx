...
export default function Contact() {
    ...
    return (
        <div className={"w-screen h-[calc(100vh-100px)] relative flex flex-row justify-around py-[4vw] -mb-[2.5rem] xl:-mb-[7.5rem] text-left text-black "}>
            ...
            <div className={"flex flex-col"}>
                <form className={"flex flex-col bg-[#282d33] px-10 py-5 rounded-md w-[40vw] bg-opacity-80 text-sm"}
                      ref={formRef}
