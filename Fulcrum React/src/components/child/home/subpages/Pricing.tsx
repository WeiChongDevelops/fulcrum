...
export default function Pricing() {
    return (
        <div className={"pricing-container w-screen h-[calc(100vh-170px)] flex flex-row p-[8vw] relative -mb-[3vw]"}>
            <img src="/src/assets/homepage-assets/pricing-background.png" className={"absolute top-0 left-0 -z-10 w-full h-[84vh]"} alt="Pricing background"/>
            <div className={"pricing-copy flex flex-col justify-start items-start text-left"}>
