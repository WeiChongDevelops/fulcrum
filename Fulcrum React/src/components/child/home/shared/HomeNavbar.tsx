  ...
  return (
    <div className={"flex flex-row justify-between items-center py-4 bg-white border-b-black border-2"}>
      ...
      <div className={"flex flex-row flex-1 justify-center items-center text-black font-semibold text-lg"}>
        <a href={"http://localhost:5173/home/about"} className={"homepage-navbar-link"}>
          About
        </a>
        <a href={"http://localhost:5173/home/pricing"} className={"mx-12 homepage-navbar-link"}>
          Pricing
        </a>
        <a href={"http://localhost:5173/home/contact"} className={"homepage-navbar-link"}>
          Contact
        </a>
      </div>
