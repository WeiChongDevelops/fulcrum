  ...
  return (
    <div className="fulcrum-animation-container">
      ...
      >
        ...
        <img
          src={`/static/assets-v2/fulcrum-animation/fulcrum-rectangle-${isDarkMode ? "grey" : "black"}.png`}
          className="fulcrum-rectangle"
          alt="Fulcrum lever"
        />
        <img
          src={`/static/assets-v2/fulcrum-animation/fulcrum-basket-${isDarkMode ? "grey" : "black"}.webp`}
          alt="Fulcrum bowl"
